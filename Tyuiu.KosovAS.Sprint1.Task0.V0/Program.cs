...
using Tyuiu.KosovAS.Sprint1.Task0.V0.Lib;

namespace Tyuiu.KosovAS.Sprint1.Task0.V0
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("* Написать програму, которая вычисляет выражение 10 / (2 + 3)             *");
            ...
            Console.WriteLine(String.Concat(Enumerable.Repeat("*", 75)));
            Console.WriteLine("* 10 / (2 + 3)" + String.Concat(Enumerable.Repeat(" ", 60)) + "*");
            Console.WriteLine(String.Concat(Enumerable.Repeat("*", 75)));
